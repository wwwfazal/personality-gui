...
UML Diagram (in case it is not visible from the file due to a bug)
![UML_Design_Diagram](https://github.students.cs.ubc.ca/user-attachments/assets/de9b1665-9859-46d4-89cc-0d0f83edcecd)
